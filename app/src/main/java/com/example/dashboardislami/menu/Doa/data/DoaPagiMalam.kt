    ...
    val listDoaPagiMalam: ArrayList<DoaModel>
        get() {
            ...
            for (data in DoaPagiMalam.doaTitle.indices) {
                val model = DoaModel()
                model.title = DoaPagiMalam.doaTitle[data]
                model.doa = DoaPagiMalam.doaDoa[data]
                model.latin = DoaPagiMalam.doaLatin[data]
                model.translate = DoaPagiMalam.doaTranslate[data]
                model.profile = DoaPagiMalam.doaProfile[data]
                list.add(model)
            }
